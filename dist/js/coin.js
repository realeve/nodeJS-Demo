...
var app = new Vue({
  ...
  watch: {
    selected: function(val) {
      ...
      axios.get('/data/goods/goods' + goodsId + '.min.json')
        .then((res) => {
          var data = res.data;
  ...
  created: function() {
    ...
    axios.get('/data/popular0.min.json')
      .then((res) => {
        var data = res.data;
    ...
    axios.get('/data/popular1.min.json')
      .then((res) => {
        var data = res.data;
    ...
    //产品分布 | 价格、主题、材质
    axios.get('/data/product-distrib.min.json')
      .then((response) => {
    ...
    axios.get('/data/bytheme.min.json')
      .then((res) => {
        var data = res.data;
    ...
    axios.get('/data/byyear.min.json')
      .then((res) => {
        var data = res.data;
    ...
    axios.get('/data/bymonth.min.json')
      .then((res) => {
        var data = res.data;
    ...
    axios.get('/data/saleByUser.min.json')
      .then((res) => {
        var data = res.data;
    ...
    axios.get('/data/order-province-map.min.json')
      .then((res) => {
        var data = res.data;
        axios.get('/data/register-province-map.min.json')
          .then((res) => {
